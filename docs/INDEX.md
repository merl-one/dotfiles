...
- **[CHEZMOI_GUIDE.md](./CHEZMOI_GUIDE.md)** - ⭐ **START HERE** - Why `chezmoi init --apply` appears silent, troubleshooting, verification
...
## 🏗️ Architecture & OpenCode

- **[OPENCODE_ARCHITECTURE.md](./OPENCODE_ARCHITECTURE.md)** - How OpenCode loads configuration, agents, skills, and commands. Why you can't see agents in Windows.
- **[TERRAFORM_SKILL_INTEGRATION.md](./TERRAFORM_SKILL_INTEGRATION.md)** - Terraform best practices skill integration with OpenCode. Usage patterns and workflows.

## 🏗️ Dev Containers & Implementation
